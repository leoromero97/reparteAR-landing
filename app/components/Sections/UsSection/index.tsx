...
function UsSection() {
  return (
    ...
    >
      <div
        className=
        'flex flex-col max-w-8xl px-8 w-full gap-6 py-10 items-center md:items-start'
      >
        ...
        <div className='flex w-full py-6 overflow-y-hidden overflow-scroll gap-4 px-3 md:flex-wrap md:gap-10 md:justify-between md:overflow-hidden'>
